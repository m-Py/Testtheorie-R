...
Auch das logische NICHT arbeitet vektorisiert, d.h. kann auf einen
logischen Vektor angewendet werden, der beliebig viele Elemente enthält
und invertiert alle Element darin:
...
nachzudenken, warum wir die Funktion `mean` hier verwendet können, um
...
können wir den relativen Anteil einfach mit 100 multiplizieren:
