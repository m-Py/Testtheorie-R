...
Sinn hat einen Vektor vom Typ `factor` anzulegen, wenn eine numerische 
...
oftmals auch die Kodierung des Geschlecht von Studienteilnehmer*innen: 
...
Gleiches funktioniert mit Vektoren vom Typ `factor`, die sich ja 
...
Wiederholt lernen wir nun schon dieses komponentenweise Verhalten 
kennen. Wir können noch eine Schippe drauf legen, indem wir 
vektorisierte logische Vergleiche mit vektorisierten UND- oder 
ODER-Operationen verbinden:
...
sie ist sehr praktisch, um sich schnell einen Blick über Daten zu 
