...
aus einfachen Vektoren "herausgreifen" können.
...
Vektors `meinVektor` größer als 5 sind (spezifisch: an welchen
Positionen ist in `meinVektor` ein Element enthalten, das größer ist als
