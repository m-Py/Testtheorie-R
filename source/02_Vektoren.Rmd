...
`meinVektor` größer als 5 sind (spezifisch: an welchen Positionen ist in
`meinVektor` ein Element, das größer ist als 5). Ich kann nun den
`[·]`-Zugriff mithilfe von `auswahl` verwenden, um nur die Elemente
