...
haben, und diese in einem *Paket* zur Verfügung gestellt haben. Mit der
Funktion `library` kann ich Pakete laden, die nicht zur Grundausstattung
von `R` gehören.[^`r incref()`] Voraussetzung ist, dass ich das Paket
