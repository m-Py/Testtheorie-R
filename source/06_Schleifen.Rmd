...
Spalten auf `data.frames`. Wer damit noch nicht vertraut ist, sollte
...
wir Umkodierungen von Items (vgl. [Kapitel 4](#umkodierung)) nicht für
...
kennen.[^`r incref()`] Das logische Prinzip einer `for`-Schleifen ist
...
In [Kapitel 4](#umkodierung) haben wir gelernt, wie wir mithilfe eines
...
in keiner Reaktion resultieren.
...
(c) zum Abspeichern der Trennschärfe im Vektor `discriminations`.
