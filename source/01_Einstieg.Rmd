...
In den ersten zwei Kapiteln beschäftigen wir uns mit wichtigen
Grundlagen, nämlich damit, wie `R` Daten darstellt. Dabei betrachten wir
zunächst die grundlegenste Datenstruktur, den Vektor ([Kapitel
2](#vektoren)). Danach lernen wir `data.frames` kennen ([Kapitel
3](#dataframes)) -- also Datentabellen, wie wir sie auch aus Excel oder
SPSS kennen. In [Kapitel 4](#psychometrie) werden wir psychometrische
