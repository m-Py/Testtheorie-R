...
Standard](https://www.psychologicalscience.org/observer/why-you-should-
become-a-user-a-brief-introduction-to-r). Inzwischen ist es normal, dass 
Datensätze zusammen mit `R`-Code zur Reproduzierbarkeit von 
Forschungsergebnissen auf offenen Internetportalen wie dem [*Open 
Science Framework*](https://osf.io/) zur Verfügung gestellt werden. 
Etwa [hier](https://osf.io/zc8n2/) findet sich öffentlicher `R`-Code aus 
einem meiner eigenen Forschungsprojekte. Mithilfe von [R 
Markdown](https://rmarkdown.rstudio.com/) können sogar 
...
APA-Format](https://github.com/crsh/papaja) (ein Beispiel für einen 
solchen Bericht findet sich [hier](https://osf.io/wnxcj/)). Dieses 
Skript selbst wurde ebenfalls mit `R` und R Markdown erstellt. Die 
Quelldateien finden sich unter https://github.com/m-Py/Testtheorie-R.
...
Skript bietet den theoretischen Unterbau. Die Übungen des Seminars und
die zur Bearbeitung nötigen Daten -- wie auch der jeweils aktuelle Stand
dieses Skripts -- können unter
...
findet sich eine online lesbare Version des Skripts. Das Skript wird
stetig aktualisiert; diese Version wurde am `r format(Sys.Date(), "%d.
%B %Y")` erstellt.
...
Ich danke Jul Tkotz für ihre wertvollen Beiträge und ihr nützliches
Feedback zum Skript. Hanna Siegers, Marlene Wettstein, Frank Calio und
Ingo Weigel danke ich für Fehlermeldungen.
...
darstellt. Dabei betrachten wir zunächst die grundlegenste
...
In Kapiteln [5](#rohdaten) lernen wir, wie wir mit Rohdaten aus
