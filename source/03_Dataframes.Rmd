...
Ausgabe auch mit der `[·,·]`-Notation zu erhalten, ist ein etwas 
komplizierterer, expliziter Ausschluss der `NA`-Werte nötig:
...
Befehl zugrunde liegt. Die gewünschte Ausgabe wird erreicht, da die logische 
Operation `NA & FALSE` immer `FALSE` ergibt.
