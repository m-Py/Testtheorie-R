...
In unserer kleinen Datentabelle `mdf` können wir mithilfe der Funktion
`paste0()` die zwei Items wie folgt auswählen:
...
einem logischen Vektor zurückgibt und demnach auch zur Spaltenauswahl genutzt
werden kann.
