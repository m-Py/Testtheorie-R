...
Alternativ funktioniert auch der Aufruf `colnames(mdf)`.
...
Anders als bei der `$`-Notation können wir den `[[·]]`-Zugriff auch mit 
numerischem Index verwenden: 

```{r}
mdf[[3]] # wähle dritte Spalte aus
```
...
Gruppierungsvariable. Interessanterweise ist das dritte 
