...
um die kombinierte logische Bedingung auszudrücken. Die Verknüpfung
mehrerer ODER-Bedingungen lässt sich durch den %in%-Operator etwas 
verkürzen: 

```{r}
mdf[mdf$Augenfarbe %in% c("blau", "grün", "braun"), ]
```
