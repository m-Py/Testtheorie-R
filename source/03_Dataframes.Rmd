...
Durch die zwei Beispiele erkennen wir also, dass das Komma in der `[·,·]`-Notation
bewirkt, ob eine Auswahl nach Zeilen oder Spalten stattfindet. **Vor dem Komma
werden Zeilen adressiert, nach dem Komma Spalten.** Allgemein ist die Syntax zum
Ansprechen von `data.frames` mit dem `[·,·]`-Zugriff die folgende:
