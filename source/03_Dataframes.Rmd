...
### Eine Zusammenfassung aller Spalten: `summary()`: 
...
Neben einigen deskriptiven Statistiken (Mittelwert, Minimum, Maximum; Häufigkeit 
bei Faktoren) kann `summary()` auch für jede Spalte angeben, wie viele Werte 
darin fehlen. In diesem Fall fehlt kein Wert, deswegen fehlt auch diese Angabe. 
