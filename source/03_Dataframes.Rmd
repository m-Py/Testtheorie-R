...
Die Tabelle `mdf` hat nun eine zusätzliche Spalte: 
...
Wie hier gezeigt ist im Vergleich zur `[·,·]`-Notation noch nicht viel 
gewonnen. Was die Funktion `subset()` so nützlich macht, ist dass sie 
zwei wichtige Zugriffe auf `data.frames` vereinfacht:
