...
## Bitte mal genau ueberlegen, was bei der folgenden
## Auswahl passiert
vanity <- paste0("score_Q", c(15, 19, 29))
vanity_items <- npi[, c(vanity, "Vanity")]
...
score1 <- npi$score_Q19 + npi$score_Q29
score2 <- npi$score_Q15 + npi$score_Q29
score3 <- npi$score_Q15 + npi$score_Q19

## (ii) ... diese Summenwerte mit dem uebrig
## gebliebenen Item korreliert.

## Trennschaerfe fuer Item 15
cor(score1, npi$score_Q15)

## Trennschaerfe fuer Item 19
cor(score2, npi$score_Q19)

## Trennschaerfe fuer Item 29
cor(score3, npi$score_Q29)
