...
besser_nach_epo <- spruenge_vorher < spruenge_nachher
...
## Beispiel: in Fragebogen?bertragung wurden fehlende Werte
## mit -99 kodiert. 
punktZahlen <- c(10, 32, 12, 42, -99, -99)

## Ersetze -99 mit NA: Rs M?glichkeit fehlende Werte zu 
## repr?sentieren
punktZahlen[punktZahlen == -99] <- NA

mean(punktZahlen) ## geht nicht
mean(punktZahlen, na.rm = TRUE) ## geht
...
spruenge_nachher[test_positiv] <- NA
